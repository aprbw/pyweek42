...
ALL_THEMES: List[Theme] = [
    ...
    Theme(
        ...
        clear_color=14,
        greed_clear_color=2,
        sand=SandPalette(body=3, border=3, glint=11, shadow=3, fat_body=3, fat_border=3, fat_glint=11),
        shard=ShardPalette(facet=8, border=7, glint=15, shadow=2, fat_facet=8, fat_border=7),
        hourglass=HourglassPalette(caps=7, cap_hl=15, cap_rivet=11, glass_walls=7, waist_neck=14, sand_a=3, sand_b=3, shadow=2),
